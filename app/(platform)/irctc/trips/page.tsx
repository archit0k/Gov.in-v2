...
function Trip({ t }: { t: (typeof TRIPS)[number] }) {
  return (
    <div className="rounded-[var(--r-md)] border border-[var(--line)] p-4">
      ...
      {t.refund && (
        <p className="mt-2 rounded-[var(--r-sm)] bg-[var(--ok-soft)] px-3 py-2 text-[12.5px] leading-relaxed text-[var(--ok)]">
