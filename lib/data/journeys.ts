      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            required: true,
            revealOn: { field: "pax", value: "other" },
            help: "This is what booking a ticket looks like when the system does not know the person. It is the only step here that works the old way.",
          },
          {
            id: "pax-age",
            kind: "text",
